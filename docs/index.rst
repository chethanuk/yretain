...
.. code-block:: bash
    ...
    fastapi-mvc available under: http://yretain.192.168.49.2.nip.io/
...
.. code-block:: bash
    ...
    ...
    Kubernetes cluster ready
    FastAPI available under: http://yretain.192.168.49.2.nip.io/
    You can delete dev-env by issuing: make clean
    vagrant@ubuntu-focal:/syncd$ kubectl get all -n yretain
    NAME                                                     READY   STATUS    RESTARTS   AGE
    pod/yretain-7f4dd8dc7f-p2kr7                1/1     Running   0          55s
    ...
    vagrant@ubuntu-focal:/syncd$ curl http://yretain.192.168.49.2.nip.io/api/ready
    {"status":"ok"}
Documentation
-------------
