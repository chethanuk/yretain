...
.. code-block:: bash
    ...
    $ yretain --help
    Usage: yretain [OPTIONS] COMMAND [ARGS]...
    ...
    Commands:
      serve  yretain CLI serve command.
    $ yretain serve --help
    Usage: yretain serve [OPTIONS]
...
.. code-block:: bash
    ...
    $ make image
    $ podman run -dit --name yretain -p 8000:8000 yretain:$(cat TAG)
    f41e5fa7ffd512aea8f1aad1c12157bf1e66f961aeb707f51993e9ac343f7a4b
    $ podman ps
    CONTAINER ID  IMAGE                                 COMMAND               CREATED        STATUS            PORTS                   NAMES
    f41e5fa7ffd5  localhost/yretain:0.1.0  /usr/bin/fastapi ...  2 seconds ago  Up 3 seconds ago  0.0.0.0:8000->8000/tcp  yretain
    $ curl localhost:8000/api/ready
    {"status":"ok"}
...
You can implement your own web routes logic straight away in ``yretain.controllers`` submodule. For more information please see `FastAPI documentation <https://fastapi.tiangolo.com/tutorial/>`__.
...
.. code-block:: bash
    ...
    Usage:
      ...
      clean-image      Clean yretain image
      install          Install yretain with poetry
      metrics          Run yretain metrics checks
      unit-test        Run yretain unit tests
      integration-test  Run yretain integration tests
      docs             Build yretain documentation
...
* RedisClient ``yretain.app.utils.redis``
* AiohttpClient ``yretain.app.utils.aiohttp_client``
...
.. code-block:: python
    ...
    from yretain.app.utils import RedisClient
...
.. literalinclude:: ../yretain/app/exceptions/http.py
    :language: python
...
All application configuration is available in ``yretain.config`` submodule.
...
.. literalinclude:: ../yretain/config/gunicorn.py
    :language: python

Routes
~~~~~~

Endpoints are defined in ``yretain.app.router`` submodule. Just simply import your controller and include it to FastAPI router:

.. literalinclude:: ../yretain/app/router.py
    :language: python
